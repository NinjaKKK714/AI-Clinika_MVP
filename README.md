...
- **AI-анализ** - интеллектуальная обработка медицинских вопросов
...
### Мобильное приложение
- [ ] Интеграция с реальными AI API для медицинских консультаций
...
- **Ошибки навигации**: Проверьте правильность импортов в `App.js`
